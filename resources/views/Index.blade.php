...
<html>
	...
	<body>
		...
		<header>
			...
			<div class="area-logo">
				<a href="{{route('/')}}"><img src="{{ asset('img/varios/logo-cinestar.png')}}"/></a>
			</div>
			<nav class="menu">
				...
				<ul class="menu-principal">
		    		<li class="menu-item"><a href="{{route('peliculas','cartelera')}}">Cartelera</a></li>
		       		<li class="menu-item"><a href="{{route('peliculas','estrenos')}}">Próximos estrenos</a></li>
